...
const createContact = async (req, res) => {
    ...
    const response = await mongodb.getDatabse().db().collection('contacts').insertOne(contact)
...
const updateContact = async (req, res) => {
    ...
    const response = await mongodb.getDatabse().db().collection('contacts').replaceOne({_id: userId}, contact)
...
const deleteContact = async (req, res) => {
    const userId = new ObjectId(req.params.id)
    const response = await mongodb.getDatabse().db().collection('contacts').deleteOne({_id: userId})
